 ...
 * Database Health
 */
export const databaseHealthHealthDbGet = <ThrowOnError extends boolean = false>(
  options?: Options<DatabaseHealthHealthDbGetData, ThrowOnError>,
) =>
  (options?.client ?? client).get<DatabaseHealthHealthDbGetResponses, unknown, ThrowOnError>({
    url: '/health/db',
    ...options,
  })
